...
function ileben_theme_render_color_scheme_switcher() {
    ...
    <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-theme-value="light" aria-label="<?php esc_attr_e('Tema claro', 'ileben-landing'); ?>" title="<?php esc_attr_e('Claro', 'ileben-landing'); ?>"><i class="fa-solid fa-sun"></i></button>
    <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-theme-value="dark" aria-label="<?php esc_attr_e('Tema oscuro', 'ileben-landing'); ?>" title="<?php esc_attr_e('Oscuro', 'ileben-landing'); ?>"><i class="fa-solid fa-moon"></i></button>
    <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-theme-value="auto" aria-label="<?php esc_attr_e('Tema automatico', 'ileben-landing'); ?>" title="<?php esc_attr_e('Automatico', 'ileben-landing'); ?>"><i class="fa-solid fa-cloud-sun"></i></button>
    </div>
