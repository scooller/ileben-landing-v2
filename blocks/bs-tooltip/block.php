...
?>
    <?php switch ($element):
        case 'button': ?>
            <button type="button" class="<?php echo esc_attr($element_class_string); ?>" <?php echo $data_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                                                                                            ?>><?php echo esc_html($elementText); ?></button>
            <?php break; ?>
        <?php
        case 'link': ?>
            <a href="#" class="<?php echo esc_attr($element_class_string); ?>" <?php echo $data_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                                                                                ?>><?php echo esc_html($elementText); ?></a>
            <?php break; ?>
        <?php
        default: ?>
            <span class="<?php echo esc_attr($element_class_string); ?>" <?php echo $data_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
