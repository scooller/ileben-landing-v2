(function() {
    ...
    registerBlockType('bootstrap-theme/bs-asesores', {
        ...
        attributes: {
            ...
            qrType: { type: 'string', default: 'none' }, // 'none' | 'whatsapp' | 'vcard'
            orderBy: { type: 'string', default: 'default' }, // 'default' | 'random' | 'alphaAsc' | 'alphaDesc'
                        ...
                        wp.element.createElement(PanelBody, { title: __('Contenido', 'bootstrap-theme'), initialOpen: false },
                            ...
                            wp.element.createElement(SelectControl, {
                                ...
                                options: [
                                    ...
                                    { label: __('QR - WhatsApp', 'bootstrap-theme'), value: 'whatsapp' },
                                    { label: __('QR - vCard', 'bootstrap-theme'), value: 'vcard' },
                                ],
                            ...
                            wp.element.createElement(SelectControl, {
                                ...
                                options: [
                                    ...
                                    { label: __('Al azar', 'bootstrap-theme'), value: 'random' },
                                    { label: __('Alfabético (A-Z)', 'bootstrap-theme'), value: 'alphaAsc' },
                                    { label: __('Alfabético (Z-A)', 'bootstrap-theme'), value: 'alphaDesc' },
                                ],
