...
function bootstrap_theme_render_bs_collapse_block($attributes, $content, $block)
{
    ...
    // Normalize variant: editor may store 'primary' or 'btn-primary'
    ...
    ob_start();
?>
    <button class="btn <?php echo esc_attr($btn_variant_class); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#<?php echo esc_attr($collapseId); ?>" aria-expanded="<?php echo $show ? 'true' : 'false'; ?>" aria-controls="<?php echo esc_attr($collapseId); ?>">
